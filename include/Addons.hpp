...
size_t get_brocker_account(const std::string &filename) // На входе: balance_00001234_20181001.txt // Tested
	{
...
std::string get_brocker_date(const std::string &filename) // На входе: balance_00001234_20181001.txt // Tested
	{
